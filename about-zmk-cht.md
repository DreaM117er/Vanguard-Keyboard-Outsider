...
排除法相信大家一定在求學當中絕對不陌生，它是「科學實驗方法」之一，在電路及韌體之間，這套法則一直都相當地好用。

公式：假設 `A + B = C` 是絕對正確的真理。那麼我可以逆向推導是 `A`、`B` 兩者其一或全部都有問題，我才會在結果上無法獲得 `C`。
...
是不是？這樣一來你一定有辦法 `100%` 做到除錯，而且不論你遇到的是藍牙、還是更艱深的底層法則，你也有辦法利用這兩個法則做到全面的解決你的大問題。
